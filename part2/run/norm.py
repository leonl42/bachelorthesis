...
if args.model == "vgg11":
    save_path = "./exps_"+args.optim+"/norm"+args.suffix+"/" + str(args.norm_scale) + "_" + str(args.norm_every) + "/run_" + args.run_id
else:
    save_path = "./exps_"+args.optim+"/norm_" + args.model + args.suffix + "/" + str(args.norm_scale) + "_" + str(args.norm_every) + "/run_" + args.run_id
